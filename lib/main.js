...
(typeof window !== "undefined" ? window : this, function(window, noglobal){
	...
	class Sinusoid {
		constructor(options = {}){
			...
			var width, height, scale, lineColor, pointColor, axisColor;
		...
		plot(offsetX, offsetY){
			...
			let x = 0, y = 0, amplitude = 30, frequency = 20;
	...
	class SineGraph extends Sinusoid {
		constructor(options){
			super(options);
			this.type = "sine";
		}
	...
	class CosineGraph extends Sinusoid {
		constructor(options){
			super(options);
			this.type = "cosine";
		}
